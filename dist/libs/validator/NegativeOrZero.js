...
function verify(propertyValue, decoratorData) {
    ...
    if (febs.utils.bigint_more_than(propertyValue, 0)) {
        return { isValid: false };
    }
...
exports.NegativeOrZero = NegativeOrZero;
//# sourceMappingURL=NegativeOrZero.js.map